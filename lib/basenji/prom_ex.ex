defmodule Basenji.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule BasenjiWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :basenji

       ...

       plug PromEx.Plug, prom_ex_module: Basenji.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: BasenjiWeb.Router, endpoint: BasenjiWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:basenji, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
